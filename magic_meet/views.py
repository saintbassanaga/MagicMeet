...
@app.route('/')
@app.route('/home')
def magicMeet_home():  # put application's code here
...
def on_join_room(data):
    ...
    if room_id not in _users_in_room:
        ...
        userList = {u_id:_name_of_sid[u_id] for u_id in _users_in_room[room_id]}
        emit("user-list", {"list": userList, "my_id": sid}) # send list of existing users to the new member
